...
int main()
{
    ...
    ifstream inputFile;
    inputFile.open("/Users/samarsingh/Desktop/CompSc./C++_sptopic/countries.txt");
    ...
    {                                                      
        ...
        ofstream outputFile;
        outputFile.open("/Users/samarsingh/Desktop/CompSc./C++_sptopic/scores.txt");
...
int wordLetters(const string words[], char blank_for_word[], const int MAX_LIST)
{
    ...
    //cout << "Your country is: " << words[random_word] << endl;
